...
class Modify_X_NMM(QMainWindow):
    ...
    def set_param(self):
        ...
        self.layout_NMM_var, self.Edit_List_NMM_var,self.Nameparam, self.colorbutton  = Layout_groupbox_Label_Edit(labelGroup ='List of variables', label = list_variable,edit =edit,popName=self.List_Names[p[0]][p[1]],popColor=self.List_Color[p[0]][p[1]], width = 150)
